 ...
 *
#!name= Widgets 𝕏
#!desc= 对 Widgets相关组件 学习探索;
#!author= 
#!homepage = 
#!icon= https://he2o.vercel.app/Resource/Icon/Loon/vip@2x.png
...
[Script]
#修改
http-response ^https:\/\/(api\.revenuecat\.com|api\.rc-backup\.com)\/.+\/(receipts$|subscribers\/[^/]+$) script-path=https://he2o.vercel.app/Resource/Plugin/Widgets.js, requires-body=true, timeout=60, tag=Widgets

#清理
http-request ^https:\/\/(api\.revenuecat\.com|api\.rc-backup\.com)\/.+\/(receipts$|subscribers\/[^/]+$) script-path=https://he2o.vercel.app/Resource/Plugin/Widgets.js, timeout=60, tag=Widgets
